...

{
    ...
    unsigned char your_name[14] = "Lili";
    ...
    Graphics_drawStringCentered(&g_sContext, your_name, AUTO_STRING_LENGTH, 38, 15, TRANSPARENT_TEXT);
    //Graphics_drawStringCentered(&g_sContext, "to", AUTO_STRING_LENGTH, 38, 25, TRANSPARENT_TEXT);
    //Graphics_drawStringCentered(&g_sContext, "ECE2049-A21!", AUTO_STRING_LENGTH, 38, 35, TRANSPARENT_TEXT);
